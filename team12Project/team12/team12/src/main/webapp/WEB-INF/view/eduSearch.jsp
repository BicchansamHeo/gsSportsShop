				 ...
				 <div class="pricing professional">
		            <div class="p-header">
		                ...
		                <div class="price">
		                    ...
		                    <h2 style="font-weight: 530; font-size: 45px;">교육실조회</h2>
		                    <span class="per"></span>
		                 </div>
		            </div>
				 </div>      		
				...
				<div class="row">
                	<div class="col-sm-6">
						<ul class="nav nav-pills">
                            ...
                            <li class="active"><a id="education"href="#" data-filter=".artwork">교육실</a></li>
                            <li><a id="site" href="#" data-filter=".artwork">건물</a></li>
               			</ul>
             		</div>
                	<div class="col-sm-6" style="text-align: right;">
                		<sec:authorize access="hasAnyRole('ROLE_EM')">
	                		<input id="" type="button" class="btn btn-info btn-sm" value="추가" onclick="location.href='/addConf.do'"/>
            ...
            <script>
           	 ...
           	 var totalPg = ${totalPg};
           		for(var i = 1; i <= totalPg; i++){
         	    	 $('#pageMenu').append("<li id='" + i + "' name='page'><a href='pagingEdu.do?index=" + i + "&roomkind=education'>" + i + "</a></li>");
