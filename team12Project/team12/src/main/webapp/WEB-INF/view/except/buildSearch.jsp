                    ...
                    <div id="primary" class="site-comtent">
                        <div class="row">
                            <div class="posts-wrap">
                               <c:forEach var="list" items="${buildList}" varStatus="status">
                         ...
                         <ul class="pagination">
                            ...
                            <li id="1" name="page" class="active"><a id="temp" href="paging.do?index=1&roomkind=education">1</a></li>
                            <li id="2" name="page" class="active"><a href="paging.do?index=2&roomkind=education">2</a></li>
                            <li id="3" name="page" class="active"><a href="paging.do?index=3&roomkind=education">3</a></li>
                            <li id="4" name="page"><a href="paging.do?index=4&roomkind=education">4</a></li>
                            <li id="5" name="page"><a href="paging.do?index=5&roomkind=education">5</a></li>
                            <li name="page"><a href="paging.do?index=1&roomkind=education">Next »</a></li>
                        </ul>
                    </div>
                    <!-- /.site-comtent -->
                </div>
